                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('cashier_client_view_records',['id'=> $client->id])}}" class="btn btn-info btn-xs">View Records</a>
                                    <a href="{{route('cashier_client_lock',['id'=> $client->id])}}" class="btn btn-danger btn-xs">Lock</a>
                                </td>
                            </tr>
    ...
    <script>
        $(document).ready( function () {
            ...
            $(".add").click(function () {
                ...
                $("#addedit_user").attr("action", "{{ route('cashier_create_client') }}");
                $("#name").val("");
                $("#email").val("");
                $("#submit").html("Add");
            });
            ...
            $(".edit").click(function () {
                ...
                $("#addedit_user").attr("action", "{{ route('cashier_client_update') }}");
                $("#id").val($(this).data('id'));
