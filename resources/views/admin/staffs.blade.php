                ...
                <table id="datatable" class="table table-hover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="edit" href="#" data-row="{{ $r }}" data-id="{{ $staff->id }}" data-toggle="modal" data-target="#addeditmodal"> 
                                        <i class="menu-icon fa fa-edit"></i> Edit 
                                    </a>
    
                                    {{-- <a class="remove" href="#" data-row="{{ $r }}" data-id="{{ $staff->id }}" data-toggle="modal" data-target="#removemodal"> 
...
@section('scripts')
    ...
    <script>
        ...
        $(".edit").click(function () {
            ...
            $("#id").val($(this).data('id'));
            $("#name").val($("tr:eq(" + $(this).data('row') +") td:eq(0)").html());
            $("#email").val($("tr:eq(" + $(this).data('row') +") td:eq(1)").html());
            $("#role_id").val($("tr:eq(" + $(this).data('row') +") td:eq(3)").html());
            $("#submit").html("Update");
        });

        $(".remove").click(function () {
            $("#id2").val($(this).data('id'));
            $("#confirm").html("Are you sure you want to remove " + $("tr:eq(" + $(this).data('row') +") td:eq(0)").html() + "?");
        });
    </script>
